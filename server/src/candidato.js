...
module.exports = {
  getCandidato: function(req, res){
    connectDB.makeConnection((con) => {
      var q = "SELECT eleitor.nome AS nome, partido.nome AS partido, cargo.nome FROM eleitor, partido, cargo, candidato WHERE eleitor.id = candidato.id_pessoa AND partido.id = candidato.id_partido AND cargo.id = candidato.id_cargo";
